...
import { UpdateUserRequest, UpdateUserResponse } from "@/shared/graphql/users/users.types";
import { getClient } from "@/shared/lib/apollo/apollo-client";

export const updateUser = async (user: Omit<UpdateUserRequest["user"], "cvsIds" | "role">) => {
