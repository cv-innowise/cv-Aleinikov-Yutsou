...
export const cvProjectsColumns: ColumnDef<ProjectItem & { project: Project }>[] = [
  {
    accessorKey: "name",
...

  {
    ...
    header: ({ column }) => <SortableColumn column={column} translateKey="internal-name" />,
  },
...

  {
    ...
    enableGlobalFilter: false,
    header: ({ column }) => <SortableColumn column={column} translateKey="start-date" />,
  },
